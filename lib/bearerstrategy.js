  ...
  jwt.verify(token, PEMkey, optionsToValidate, (err, verifiedToken) => {
    ...
    if (err) {
      if (err.message && !self._options.loggingNoPII) {
        console.log(' -------------------------------------------------------------- ')
        console.log(' Passport-azure-ad: Authentication FAILED ')
        console.log(' ERROR: In Strategy.prototype.jwtVerify: cannot verify token: ', err.message);
        console.log(' -------------------------------------------------------------- ')
        ...
        console.log(' -------------------------------------------------------------- ')
        console.log(' Passport-azure-ad: Authentication FAILED ')
        console.log(' ERROR: In Strategy.prototype.jwtVerify: cannot verify token', { err }); // HERE
        console.log(' -------------------------------------------------------------- ')
